                                ...
                                <div class="site-top-icons">
                                    <ul>
                                        ...
                                        <%if(session.getAttribute("mId") == null){ %>
                                            ...
                                            <li><a href="#" onclick="loginChk();"><span class="icon icon-person"></span></a></li>
                                            <li>
	                                            <a href="#" onclick="loginChk();" class="site-cart">
	                                                <span class="icon icon-shopping_cart"></span>
	                                            </a>
	                                        </li>
                                        <%}else{ %>
                                            <li><a href="/starbucks/member/logoutAction.jsp">logout</a></li>
                                            <li><a href="/starbucks/my/"><span class="icon icon-person"></span></a></li>
                                            <li>
