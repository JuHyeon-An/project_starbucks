        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                    <h3 class="footer-heading mb-4">Information</h3>
                    <ul class="list-unstyled">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="block-5 mb-5">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="phone"><a href="tel://">TEL : 02) 3015-1100</a></li>
                            <li class="email">info@starbucks.com</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<!--                         <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script> -->
    ...
    <script src="/starbucks/js/popper.min.js"></script>
    <script src="/starbucks/js/bootstrap.min.js"></script>
    <script src="/starbucks/js/owl.carousel.min.js"></script>
    <script src="/starbucks/js/jquery.magnific-popup.min.js"></script>
