				...
				<form action="" class="tm-signup-form">
					<div class="row">
						<div class="form-group col-lg-4">
							...
							<input id="mId" name="mId" type="text" value="${vo.mId }" class="form-control validate" />
						</div>
						<div class="form-group col-lg-4	">
							<label for="mName">이름</label> 
							<input id="mName" name="mName" value="${vo.mName }"type="text" class="form-control validate" />
						</div>
					<div class="form-group col-lg-4">
						<label for="savedMoney">적립금</label> 
						<input id="savedMoney" name="savedMoney" type="text" value="${vo.savedMoney }"class="form-control validate" />
					</div>
					</div>
				<div class="row">
					<div class="form-group col-lg-4">
