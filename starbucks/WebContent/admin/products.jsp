				...
				<div id="mainDiv"
					...
					<form id="frmSearch" method="post" name="frmSearch" class="input-group col-lg-4 mb-3">
						...
						<div class="input-group-append">
							<button class="input-group-text search-span" id="btnSearch-item" 
							name="btnSearch-item">검색</button>
						</div>
						</form>
					</div>
								...
								<c:forEach var="vo" items="${list }">
									...
									<tr>
										<td scope="row"><img width="95%" height="95%"
											class="round" alt="Starbucks Starbucks Korea 2020 Spring "
										...
										<td>${vo.item_num }</td>
										<td>${regDate }</td>
										<td><a href="#" onclick="deleteItem('${vo.item_code}')"
