...
public class MemberVo {
	...
	public String getMember_savedmoney() {
		return member_savedmoney;
	}
	public void setMember_savedmoney(String member_savedmoney) {
		this.member_savedmoney = member_savedmoney;
	}
